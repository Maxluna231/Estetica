...
<body>
    ...
    <div class="imagen1" class="contenedor-responsive">
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <img class="imagen1" src="http://localhost/proyecto-estetica/imagenes/manicure.jpg">
            </li>
            <li class="nav-item">
                <img class="imagen1" src="http://localhost/proyecto-estetica/imagenes/maquillaje.jpg">
            <li class="nav-item">
            </li>
            <li class="nav-item">
                <img class="imagen1" src="http://localhost/proyecto-estetica/imagenes/pedicure.jpg">
            </li>
    ...
    <div class="imagen1" class="contenedor-responsive">
        <ul class="nav nav-pills nav-fill">
            <li class="nav-item">
                <img id="imagen1" class="imagen" src="http://localhost/proyecto-estetica/imagenes/corte.jpg">
            </li>
            <li id="imagen1" class="nav-item">
                <img class="imagen1" src="http://localhost/proyecto-estetica/imagenes/depilacion.jpg">
            </li>
            <li id="imagen1" class="nav-item">
                <img class="imagen1" src="http://localhost/proyecto-estetica/imagenes/masaje.jpg">
